...
public class updatePaymentStatusController implements Initializable
{
	...
	@FXML RadioButton paid;
	@FXML RadioButton unpaid;
	@FXML Label label_paymentStatus;
	...
	public void getSelectedPropertyType(ActionEvent ae)
	{
		...
		if(apartment.isSelected())
		{
			...
			label_paymentStatus.setLayoutY(350);
			paid.setLayoutY(350);
			unpaid.setLayoutY(350);
			button_addTenant.setLayoutY(390);
	...
	public void updatePaymentStatus(ActionEvent ae)
	{
		...
		if(propertyFieldBean.propertyType == 1)
		{
			...
			if(paid.isSelected())
			{
				propertyFieldBean.paymentStatus = "Paid";
			}
			else if(unpaid.isSelected())
			{
				propertyFieldBean.paymentStatus = "Unpaid";
			}
			...
			Thread thread = new Thread(new Runnable()
			{
				public void run()
				{
					propertyFieldBean.serverResponse = propertyFieldBean.controller.updatePaymentStatusController(propertyFieldBean.name, propertyFieldBean.email, propertyFieldBean.paymentStatus, propertyFieldBean.propertyType, propertyFieldBean.city, propertyFieldBean.state, propertyFieldBean.postalCode, propertyFieldBean.apartmentNumber);
...
//			System.out.println(propertyFieldBean.serverResponse);
		...
		else if(propertyFieldBean.propertyType == 2)
		{
			...
			Thread thread = new Thread(new Runnable()
			{
				public void run()
				{
					propertyFieldBean.serverResponse = propertyFieldBean.controller.updatePaymentStatusController(propertyFieldBean.name, propertyFieldBean.email, propertyFieldBean.paymentStatus, propertyFieldBean.propertyType, propertyFieldBean.city, propertyFieldBean.state, propertyFieldBean.postalCode, propertyFieldBean.condoStreetNumber+"",propertyFieldBean.unitNumber+"");
					System.out.println(propertyFieldBean.serverResponse);
				}	
			});
			thread.start();
