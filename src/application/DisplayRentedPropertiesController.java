...
public class DisplayRentedPropertiesController implements Initializable
{
	...
	public void refreshList()
	{
		Thread thread = new Thread(new Runnable()
		{
			public void run()
			{
				propertyFieldBean.list =  propertyFieldBean.controller.getAllRentedUnitsController();
				printTable();
			}	
		});
		thread.start();
